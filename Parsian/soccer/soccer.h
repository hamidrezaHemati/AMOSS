...
private:
	...
	// PLANS
	void Defense(int ids[], int size, const rcsc::Vector2D &first, const rcsc::Vector2D &second);
	void DefensePosition(int size, rcsc::Vector2D *first, rcsc::Vector2D *second);
	...
	void gotoPointAvoid(int id, const rcsc::Vector2D& targetPos, const rcsc::Vector2D& targetVel);
	void gotoPointAvoidPenaltyA(int id, const rcsc::Vector2D& targetPos, const rcsc::Vector2D& targetVel);
